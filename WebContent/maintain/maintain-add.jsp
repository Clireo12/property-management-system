			...
			<main class="col-lg-10 col-md-9 ms-sm-auto px-md-4 py-4">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb mb-0"
							...
							<li class="breadcrumb-item active"
								style="color: #f8f9fa; font-size: 16px">添加报修</li>
						</ol>
					</nav>
				</div>
				...
				<div class="card shadow-sm mb-4">
					<div class="card-header bg-primary text-white">
						<h5 class="mb-0">
							<i class="fas fa-tools me-2"></i>添加报修信息
						</h5>
					</div>
					<div class="card-body form-container">
						<form role="form" action="../main?action=maintainAdd"
							method="post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-section">
										<label class="form-label required-field">报修物品</label> <input
											type="text" class="form-control" name="thing" required>
									</div>
									...
									<div class="form-section">
										<label class="form-label required-field">报修人</label> <input
											type="text" class="form-control" name="maintainer" required>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-section">
										...
										<div class="input-group date date-picker" data-date=""
											...
											<input class="form-control" name="sdate" type="text" required>
									...
									<div class="form-section">
										<label class="form-label required-field">预计花费</label> <input
											...
											pattern="^[0-9]+(\.[0-9]{0,2})?$" required> <small
