				...
				<div class="sidebar-nav">
					<ul class="nav nav-pills flex-column">
						...
						<li class="nav-item"><a class="nav-link active"
							href="index.jsp"> <i class="fas fa-home"></i>首页
						</a></li>
					...
					<div class="col-md-4 mb-4">
						<div class="card h-100 border-0 shadow-sm">
							<div class="card-body text-center">
								...
								<p class="card-text">管理系统管理员账户</p>
								<a href="admin?action=adminList" class="btn btn-outline-primary">管理账户</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 mb-4">
						<div class="card h-100 border-0 shadow-sm">
							<div class="card-body text-center">
								...
								<p class="card-text">处理业主报修申请</p>
								<a href="main?action=maintainList"
									class="btn btn-outline-warning">处理报修</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 mb-4">
						<div class="card h-100 border-0 shadow-sm">
							<div class="card-body text-center">
								...
								<p class="card-text">查看和修改业主的个人信息</p>
								<a
