			...
			<main class="col-lg-10 col-md-9 ms-sm-auto px-md-4 py-4">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb mb-0"
							...
							<li class="breadcrumb-item"><a
								...
								style="color: white; font-size: 16px">业主信息</a></li>
							<li class="breadcrumb-item active"
								style="color: #f8f9fa; font-size: 16px">编辑业主</li>
						</ol>
					</nav>
				</div>
				...
				<div class="card shadow-sm mb-4">
					<div class="card-header bg-primary text-white">
						<h5 class="mb-0">
							<i class="fas fa-edit me-2"></i>编辑业主信息
						</h5>
					</div>
					<div class="card-body form-container">
						...
						<form id="editForm" role="form"
							action="custom?action=customAccountEdit" method="post"
							onsubmit="return validateForm()">
							<div class="row">
								<div class="col-md-6">
									<div class="form-section">
										<label class="form-label required-field">用户名</label> <input
											type="text" class="form-control" name="username"
											value="${customAccount.username}" required>
									</div>

									<div class="form-section">
										<label class="form-label required-field">业主编号</label> <input
											type="text" class="form-control" name="ownerid"
											value="${customAccount.ownerid}" required>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-section">
										...
										<small class="form-text text-muted">密码由字母、数字或下划线组成，6-18位</small>
									</div>

									<div class="form-section">
										<label class="form-label">车牌号</label> <input type="text"
											class="form-control" name="carid"
											value="${customAccount.carid}">
									</div>
								</div>
							</div>
							...
							<div class="form-section">
								<label class="form-label">业主照片</label>
								<div class="mb-2">
								...
								<input type="file" class="form-control" name="ownerImage"
									accept="image/*"> <small class="form-text text-muted">请上传新的业主照片
									(JPG/PNG格式)</small> <input type="hidden" name="existingImage"
									value="${customAccount.owner_image}">
							</div>

							<input type="hidden" name="accountid"
								value="${customAccount.accountid}">
	...
	<script>
		...
		function validateForm() {
			...
			if (!passwordRegex.test(password1.value)) {
				alert('密码格式不正确！必须由字母、数字或下划线组成，6-18位');
				password1.focus();
				return false;
			}
