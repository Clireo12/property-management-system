			...
			<div class="col-lg-2 col-md-3 d-none d-md-block p-0">
				<div class="sidebar-nav">
					<ul class="nav nav-pills flex-column">
						...
						<li class="nav-item"><a class="nav-link"
							href="../house?action=houseList"> <i
								class="fas fa-house-user"></i>房产信息
						</a></li>
					</ul>
				</div>
			</div>
			...
			<main class="col-lg-10 col-md-9 ms-sm-auto px-md-4 py-4">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb mb-0"
							...
							<li class="breadcrumb-item active"
								style="color: #f8f9fa; font-size: 16px">添加业主</li>
						</ol>
					</nav>
				</div>
				...
				<div class="card shadow-sm mb-4">
					<div class="card-header bg-primary text-white">
						<h5 class="mb-0">
							<i class="fas fa-user-plus me-2"></i>添加业主信息
						</h5>
					</div>
					<div class="card-body form-container">
						...
						<form id="addForm" role="form"
							action="../custom?action=customAccountAdd" method="post"
								...
								<div class="col-md-6">
									...
									<div class="form-section">
										<label class="form-label required-field">业主编号</label> <input
											type="text" class="form-control" name="ownerid" required>
									</div>
								</div>
							...
							<div class="form-section">
								<label class="form-label">业主照片</label> <input type="file"
									class="form-control" name="ownerImage" accept="image/*">
								<small class="form-text text-muted">请上传业主照片 (JPG/PNG格式)</small>
							</div>
