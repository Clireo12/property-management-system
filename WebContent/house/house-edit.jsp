				...
				<div
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb mb-0"
							...
							<li class="breadcrumb-item"><a href="house?action=houseList"
								style="color: white; font-size: 16px">房产信息</a></li>
							<li class="breadcrumb-item active"
								style="color: #f8f9fa; font-size: 16px">编辑房产</li>
						</ol>
					</nav>
				</div>
								...
								<div class="col-md-6">
									...
									<div class="form-section">
										<label class="form-label required-field">单元</label> <input
											...
											value="${house.unit}" required>
									</div>

									<div class="form-section">
										<label class="form-label required-field">楼层</label> <input
											type="number" class="form-control" name="floor"
											value="${house.floor}" required>
									</div>
								...
								<div class="col-md-6">
									<div class="form-section">
										<label class="form-label">业主编号</label> <input type="text"
											class="form-control" name="ownerid" value="${house.ownerid}">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-section">
										<label class="form-label">备注</label> <input type="text"
											class="form-control" name="memo" value="${house.memo}">
									</div>
								</div>
							</div>

							<!-- 在表单中添加隐藏域，存储ID（从后端回显） -->
